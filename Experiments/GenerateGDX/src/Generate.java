...
public class Generate {
	...
	public static void main(String[] args) {
        ...
        wsInfo.setWorkingDirectory("C:\\Users\\Dog\\Desktop\\data\\IIS");
    ...
    private static void setData(GAMSWorkspace ws, int num){
        ...
        task.run(opt, db);
        task.OutDB().export("C:\\Users\\Dog\\Desktop\\data\\IIS\\" + "Dog" + num + ".gdx" );
    }
